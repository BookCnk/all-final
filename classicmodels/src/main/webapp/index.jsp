...
<head>
    ...
    <script>
        ...
        function logout() {
            // document.getElementById("login-menu").innerHTML = "<i class='bi bi-box-arrow-in-right'></i> Login</a>"
...
<div class="container" id="body-content"><h3>SIT-202: Classic Model Online</h3>
    ...
    <p>SIT-202 is a young and dynamic company specialized in the online sale of static collectible models and related
        accessories. Our location are distributed around the world. <br> … they are popular collectibles for every
        automobile fan.rs! .. </p>
</div>
<jsp:include page="WEB-INF/jsp/view-cart.html"/>
