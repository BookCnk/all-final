...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="office-list" target="_blank">
            <span class="ms-4 font-weight-bold">Classic Moldels</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <%--office-list--%>
            <li class="nav-item">
                <a class="nav-link" href="office-list">
                    ...
                    <span class="nav-link-text ms-1">Offices List</span>
                </a>
            </li>
            <%--office-edit--%>
            <li class="nav-item">
                <a class="nav-link  active" href="office-edit">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Offices Edit</span>
                </a>
        </ul>
    </div>
</aside>
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Office Edit</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Office Edit</h6>
            </nav>
        </div>
    </nav>
    <!-- End Navbar -->
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="card mb-4">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <form>
                                    <div class="input-group">
                                        <a href="javascript:loadOfficesFind()" class="input-group-text text-body"
                                           id="search-icon">
                                            <i class="fas fa-search" aria-hidden="true"></i>
                                        </a>
                                        <input type="text" name="find" class="form-control"
                                               placeholder="CityOrCountry..." id="inputSearch">
                                    </div>
                                    <c:if test="${massage != null}"><span style="color: red">${massage}</span></c:if>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0" id="content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                        <form method="post" name="office-update" class="p-4">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="city" class="form-label">City:</label>
                                    <input type="text" class="form-control" id="city" name="city"
                                           value="${office.city}" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="addressLine1" name="addressLine1"
                                           value="${office.addressLine1}" required>
                                </div>
                                <div class="col-md-6">
                            ...
                            <a href="office-edit" class="btn btn-danger">Cancel</a>
                        </form>
                </div>
            </div>
        </div>
        <a href="insert-office" class="btn btn-primary">Add Office</a>
    </div>
</main>
...
<script>
    function loadOfficesFind() {
        ...
        xhttp.open("POST", "office-find");
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send("find=" + inputSearch);
    }
</script>
