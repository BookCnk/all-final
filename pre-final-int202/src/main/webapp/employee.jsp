...
<c:forEach items="${requestScope.employeeList}" var="employee">
    <div class="office-container">
        <h1 class="office-code">${employee.employeeNumber}</h1>
        <hr>
        <h2 class="office-location">${employee.firstName}, ${employee.lastName}</h2><br>
        <p class="office-address">${employee.email}</p><br>
        <p class="office-address">${employee.jobTitle}</p>
    </div>
</c:forEach>
</body>
</html>
